    ...
    <TexProvider>
        <ViewStateManager
            ...
            annotations={[
                ...
                {id: 1, start: 580, stop: 808, author: "Finn Macken", date: "today", content: "Hi guys!"},
                {id: 2, start: 1190, stop: 1278, author: "Finn Macken", date: "today", content: "Hi guys!"},
                {id: 3, start: 2348, stop: 2558, author: "Finn Macken", date: "today", content: "Hi guys!"},
                {id: 4, start: 1193, stop: 1208, author: "Finn Macken", date: "today", content: "Hi guys!"},
                {id: 5, start: 1259, stop: 1276, author: "Finn Macken", date: "today", content: "Hi guys!"},
                {id: 6, start: 1108, stop: 1142, author: "Finn Macken", date: "today", content: "Hi guys!"},
                {id: 7, start: 1229, stop: 1251, author: "Finn Macken", date: "today", content: "Hi guys!"},
                {id: 8, start: 1259, stop: 1339, author: "Finn Macken", date: "today", content: "Hi guys!"},
