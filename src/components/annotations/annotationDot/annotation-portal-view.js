...
function AnnotationPortalView(props){
  ...
  useEffect(()=>{
    console.log('ANNOTATIONS [STATE, ANNOTATION-PORTAL-VIEW]:', annotations)
  }, [annotations])
  ...
  function handlePositiveClick(){
    ...
    for(var annotation of props.annotations){
      if(annotation.data.position === 'POSITIVE'){
  ...
  function handleNegativeClick(){
    ...
    for(var annotation of props.annotations){
      if(annotation.data.position === 'NEGATIVE'){
