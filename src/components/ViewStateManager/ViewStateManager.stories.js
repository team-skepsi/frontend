...
export const Example = () => (
    <TexProvider>
        <ViewStateManager
            ...
            annotations={[
                {id: 0, start: 150, stop: 304, author: {username: "Finn Macken"}, date: "today", content: "Hi guys!", children: [9, 10]},
                {id: 1, start: 580, stop: 808, author: {username: "Finn Macken"}, date: "today", content: "The saladbar is great!"},
                {id: 2, start: 1190, stop: 1278, author: {username: "Finn Macken"}, date: "today", content: "bruh"},
                {id: 3, start: 2348, stop: 2558, author: {username: "Finn Macken"}, date: "today", content: "my favorite place to get lunch"},
                {id: 4, start: 1193, stop: 1208, author: {username: "Finn Macken"}, date: "today", content: "here"},
                {id: 5, start: 1259, stop: 1276, author: {username: "Finn Macken"}, date: "today", content: "another one"},
                {id: 6, start: 1108, stop: 1142, author: {username: "Finn Macken"}, date: "today", content: "text"},
                {id: 7, start: 1229, stop: 1251, author: {username: "Finn Macken"}, date: "today", content: "foo"},
                {id: 8, start: 1259, stop: 1339, author: {username: "Finn Macken"}, date: "today", content: "stuff"},
                {id: 9, author: {username: "Finn Macken"}, content: "exactly", date: "today"},
                {id: 10, author: {username: "Finn Macken"}, content: "YASS!", date: "today"},
            ]}
        />
    </TexProvider>
)
